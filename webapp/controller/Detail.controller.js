sap.ui.define([
	...
	"com/wedonate/ssc/eng/util/Formatter",
	"sap/ui/Device",
	"sap/m/MessageBox"
], function(Controller, Formatter, Device, MessageBox) {
	"use strict";

	return Controller.extend("com.wedonate.ssc.eng.controller.Detail", {
		/**
		...
		openDialog: function(sI18nKeyword) {
			if (!this._dialog) {
				...
				this._dialog = sap.ui.xmlfragment(frgId, "com.wedonate.ssc.eng.view.MsgDialog", this);
		...
		openCancelConfirmDialog: function() {
			if (!this._cancelConfirmDialog) {
				...
				this._cancelConfirmDialog = sap.ui.xmlfragment(frgId, "com.wedonate.ssc.eng.view.CancelConfirmDialog", this);
		...
		showEmptyView: function() {
			this.getRouter().myNavToWithoutHash({
				...
				targetViewName: "com.wedonate.ssc.eng.view.NotFound",
				targetViewType: "XML"
			});
		},
		...
		openDeleteConfirmDialog: function() {
			if (!this._deleteConfirmDialog) {
				...
				this._deleteConfirmDialog = sap.ui.xmlfragment(frgId, "com.wedonate.ssc.eng.view.DeleteConfirmDialog", this);
