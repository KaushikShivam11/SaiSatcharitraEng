sap.ui.define([
	...
	return Controller.extend("com.wedonate.ssc.eng.controller.App", {
		/**
		...
		synFinished: function() {
			...
			if (errorNum > 0) {
				if (!this._errDlg) {
					this._errDlg = sap.ui.xmlfragment("errorArchiveDialog", "com.wedonate.ssc.eng.view.ErrorArchive", this);
